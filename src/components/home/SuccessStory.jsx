    ...
    <section className="relative">
      <div className="max-w-screen-xl mx-auto px-4 md:px-6 lg:px-8 py-16">
        <div className="relative rounded-2xl overflow-hidden">
          ...
          <div className="absolute bottom-6 left-6 right-6 md:right-auto md:w-[520px] bg-green-50 rounded-xl shadow p-6">
            {/* slim red accent bar on the overlay card */}
            ...
            <div className="mt-4">
              <NavLink to="/donation-request" className="btn btn-outline btn-sm text-lg text-red-500 border-white">
      ...
      <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none translate-y-1">
        ...
        >
          <path
            ...
            fill="#fee2e2"  /* matches your earlier wave tone */
          />
        </svg>
      </div>
    </section>
